<template>
  <div class="filters">
    ...
    <div class="form-group">
      ...
      <input type="text" id="search" placeholder="Pelicula..." v-model="searchQuery" class="form-control" />
    </div>
    <button @click="applyFilters" class="btn btn-primary pb-5">Apply Filters</button>
  </div>
</template>
